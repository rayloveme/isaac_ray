...
It renames all the occurrences of IsaacRay (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the IsaacRay folder
        os.rename(
            os.path.join(root_dir_path, "exts", "IsaacRay", "IsaacRay"),
            os.path.join(root_dir_path, "exts", "IsaacRay", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "IsaacRay"), os.path.join(root_dir_path, "exts", new_name))
